...
- 23.10.2025 — Добавлена поддержка платы JC3248W535C (AXS15231B QSPI, 320x480, 3.5").
- 23.10.2025 — Обновлены библиотеки liblwip.a и libesp_netif.a для ESP-IDF 5.5 (stable). Оптимизированы параметры LwIP для улучшения стабильности аудио стриминга и работы веб-сервера. Библиотеки в `library!/esp32s3_5.5_stable/`.
